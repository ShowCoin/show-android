...
public class PtrFrameLayout extends ViewGroup {
    ...
    public PtrFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mPtrIndicator.setContext(context);
...
//                Log.e("simon","mDisableWhenHorizontalMove:["+mDisableWhenHorizontalMove+"],!mPreventForHorizontal:["+(!mPreventForHorizontal)+"],Math.abs(offsetX) > Math.abs(offsetY):["+(Math.abs(offsetX) > Math.abs(offsetY))+"]");
