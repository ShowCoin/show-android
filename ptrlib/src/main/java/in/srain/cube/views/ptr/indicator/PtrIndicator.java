...
public class PtrIndicator {
    ...
    private float mRefreshHeight = 70f;//刷新的高度
    private float mCanRefreshHeight = 70f;//拉倒什么位置可以刷新的高度
...
//        mOffsetToRefresh = (int) (mRatioOfHeaderHeightToRefresh * mHeaderHeight);
        mOffsetToRefresh = PtrLocalDisplay.dipToPX(getContext(),mCanRefreshHeight);
    }
    ...
    public int getOffsetToKeepHeaderWhileLoading() {
        return mOffsetToKeepHeaderWhileLoading >= 0 ? mOffsetToKeepHeaderWhileLoading : PtrLocalDisplay.dipToPX(getContext(),mRefreshHeight);
    }
