...
import one.show.live.view.CustomDialogView;
...
public class PlayEndFragment extends BaseFragment implements MyWorkView{
    ...
    public static PlayEndFragment getInstance(POIMEnd bean, POLive liveBean) {
        PlayEndFragment endFragment = new PlayEndFragment();
