...
import one.show.live.BekeApplication;
...
import one.show.live.util.AnimUtil;
...
import one.show.live.live.widget.BigAnimContainer;
import one.show.live.log.Logger;
import one.show.live.po.POPublisherEnd;
import one.show.live.po.eventbus.EBOCloseRoom;
import one.show.live.po.eventbus.EBORefreshBeike;
import one.show.live.po.eventbus.EBORefreshList;
import one.show.live.publisher.presenter.PublisherPresenter;
import one.show.live.publisher.view.PublisherView;
    ...
    private OnRoomEventListener onRoomEventListener = new OnRoomEventListener() {
        ...
        public void exit(boolean isAsk) {
            if (isAsk) {
                ...
                new ActionSheetDialog(LiveShowActivity.this)
                        .builder()
                        .setCancelable(true)
