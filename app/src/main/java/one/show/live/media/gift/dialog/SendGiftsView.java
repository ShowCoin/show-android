...
import one.show.live.media.gift.db.DataBaseManager;
import one.show.live.media.gift.request.BuyGiftsRequest;
import one.show.live.media.gift.request.GetGiftsListRequest;
import one.show.live.media.model.GetBalanceRequest;
import one.show.live.media.po.POGift;
import one.show.live.media.po.POGiftList;
import one.show.live.media.util.LiveUiUtils;
import one.show.live.media.widget.GiftDoubleHitProgressBar;
...
//        mSendGiftBtn.setBackgroundResource(R.drawable.shape_bg_send_gift_unclickable);
        ...
        width = DeviceUtils.getScreenSize(getContext()).widthPixels;
