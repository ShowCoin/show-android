...
public class PlayLiveFragment extends PlayFragment {
  ...
  public static one.show.live.media.play.ui.PlayLiveFragment getInstance(POLive bean) {
    one.show.live.media.play.ui.PlayLiveFragment playFragment = new one.show.live.media.play.ui.PlayLiveFragment();
