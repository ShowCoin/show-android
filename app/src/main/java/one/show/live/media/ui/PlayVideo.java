...
public class PlayVideo extends PlayFragment {
  ...
  private POLive liveVideo;
  private String playStream;
  private int srcWidth, srcHeight;
  DisplayMetrics dm;
  @BindView(R.id.surfaceview) SurfaceView liveSurface;
  private boolean isStopPlay;

  @BindView(R.id.btn_share) ImageView shareBtn;

  public static one.show.live.media.play.ui.PlayVideo getInstance(POLive bean) {
    one.show.live.media.play.ui.PlayVideo playFragment = new one.show.live.media.play.ui.PlayVideo();
    playFragment.liveVideo = bean;
    return playFragment;
  }
  ...
  protected void initView() {
    super.initView();
    if (liveVideo != null) {
      playStream = liveVideo.getStream_addr();
    }
  ...
  protected void showShareDialog() {
    ShareDialog dialog = ShareDialog.newInstance(liveVideo);
